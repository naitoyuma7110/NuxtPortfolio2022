<template>
  <div>
    ...
    <v-row class="my-5">
      <v-col cols="12" sm="7">
        <v-card class="grey darken-4" height="100%">
          ...
          <v-card-text class="mb-1 text-body-1 grey--text text--lighten-2">
      ...
      <v-col cols="12" sm="5">
        <v-card class="grey darken-4" height="100%">
          ...
          <v-card-text class="grey--text text--lighten-2 text-body-1">
    ...
    <v-alert dense dark color="blue-grey" class="pa-4">
      <v-row align="center">
        <v-col class="grow">
